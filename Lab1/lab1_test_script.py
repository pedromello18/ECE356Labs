...
def check_binary_valid(prog_path):
    ...
    try:
        ...
        client.close()
        return 1
    except pexpect.TIMEOUT as xxx_todo_changeme2:
        pexpect.EOF = xxx_todo_changeme2
        client.close()
        return 0
            ...
            def send_message(client_handle, message):
                ...
                if message != 'EOF':
                    try:
                        ...
                        client_handle.before = client_handle.before.decode("utf-8")
                        ...
                        if message == reply:
                            ...
                            return 0
                    except pexpect.TIMEOUT as xxx_todo_changeme:
                        pexpect.EOF = xxx_todo_changeme
                        return 0
                else:
                    try:
                        client_handle.expect('Enter message:', timeout=4)
            ...
            def start_client(client_number):
                ...
                try:
                    ...
                    if i == 1:
                        ...
                        return 0
                except pexpect.TIMEOUT as xxx_todo_changeme1:
                        pexpect.EOF = xxx_todo_changeme1
